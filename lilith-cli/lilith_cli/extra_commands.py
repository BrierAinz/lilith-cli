...
async def run_help_command(session: SessionRuntime, args: str) -> None:  # noqa: ARG001
    ...
    catalog: dict[str, list[tuple[str, str]]] = {
        "Session": [
            ...
            ("btw", "Pregunta rápida al modelo sin guardar en el historial [<pregunta>]"),
            ...
            ("clear-screen", "Alias de /cls — limpia el terminal sin tocar historial"),
        ...
        "Development": [
            ...
            ("batch", "Dispatch de múltiples prompts en secuencia [--continue-on-error]"),
            ("pipeline", "Ejecutar pipeline declarativo desde archivo YAML/JSON"),
            ("workflow", "Ejecutar workflow persistente [list|run|show|delete]"),
        ...
        "Files & Git": [
            ...
            ("diff-branch", "Diff HEAD vs ref arbitraria [stats] [<archivo>]"),
            ...
            ("pr", "Crear PR contra la rama base (gh CLI) [title|body|base|draft]"),
            ("security-review", "Auditar patrones de seguridad en árbol [path] [--json] [--max N]"),
        ],
        "Utilities": [
            ...
            ("random", "Valores aleatorios criptográficos [int|str|token|bytes|choice]"),
        ...
        "Help": [
            ...
            ("how", "Cómo usar un slash command [<comando>]"),
            ("completion", "Generar scripts de completion para bash/zsh/fish/powershell"),
            ("tour", "Tour completo"),
