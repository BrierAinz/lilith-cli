...
la sesión se interrumpe. `forja_promote_design` convierte el candidato elegido
en un diseño inmutable de Atelier e inicia `apparel-v1` en una sola llamada.
Para una sola imagen permanece `forja_generate`.
