...
class TestCatalogCounts:
    ...
    def test_tool_names_count(self) -> None:
        # Lock-in: 22 BaseTool subclasses shipped today in lilith-tools
        # (browser + chunk_recall/ingest/store_stats + coding + 2 fs +
        # 8 local_context + package_guard + security_scan + 2 system +
        # 2 vision + web_search). If this changes, the spec also
        # changes intentionally -- update both this number and TOOL_NAMES.
